...
for my_label in range(label_len):
  ...
  with open('datasets/{}/learned_sentences_for_{}.pickle'.format(datasets,my_label),'rb') as f:
...
for _, my_h in enumerate([0,1,-1,2,-2]):
  ...
  print()
  print("Case h = {}".format(my_h))
  print("accuracy = {}".format(accurately_classified_nodes))
